export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTicketSelectNone: "Clear selection",
        codexTicketNoTypes: "No plans selected. Ticket harvesting and missing-ticket blocking are inactive.",
        codexTicketTypeLabels: {
          free: "Free",
          plus: "Plus",
          pro: "Pro",
          prolite: "Pro Lite (personal)",
          team: "Team",
          business: "Business",
          self_serve_business_prolite: "Business Pro Lite (self_serve_business_prolite)",
          self_serve_business_usage_based: "Business usage-based (self_serve_business_usage_based)",
          enterprise: "Enterprise",
          edu: "Education",
          other: "Other / unknown plans",
        },
