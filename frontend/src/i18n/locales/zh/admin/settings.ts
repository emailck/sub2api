    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTicketEnabledDesc:
          '关闭后不打票、不注入 x-codex-turn-state，按原链路转发。开启后后台打票，并在业务请求中覆盖该头。默认个人目标长度为 292，Team/Business（含 self_serve_business_prolite）为 332；缺票拦截对两类账号均生效。',
        codexTicketAccountTypes: '参与打票的套餐类型',
        codexTicketAccountTypesDesc: '仅对选中的套餐打票、注入已获取的票据，并按配置执行缺票拦截。未选中的套餐正常转发。保存后生效，多实例通常约 5 秒同步；正在进行的探测可能完成本次请求。',
        codexTicketSelectAll: '全选',
        codexTicketSelectNone: '清空选择',
        codexTicketNoTypes: '未选择任何类型，当前不会打票或进行缺票拦截。',
        codexTicketTypeLabels: {
          free: 'Free（免费）',
          plus: 'Plus',
          pro: 'Pro',
          prolite: 'Pro Lite（个人）',
          team: 'Team',
          business: 'Business',
          self_serve_business_prolite: 'Business Pro Lite（self_serve_business_prolite）',
          self_serve_business_usage_based: 'Business 按量计费（self_serve_business_usage_based）',
