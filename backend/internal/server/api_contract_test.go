		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"openai_codex_ticket_account_types": ["free", "plus", "pro", "prolite", "team", "business", "self_serve_business_prolite", "self_serve_business_usage_based", "enterprise", "edu", "other"],
