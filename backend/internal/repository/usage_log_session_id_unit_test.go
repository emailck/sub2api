...
// precedes error_code and created_at, which are always the final two args.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 60, "arg-type table must include response-model audit fields, session_id, and error_code")
	...
	// created_at is last and error_code is penultimate; session_id precedes both.
