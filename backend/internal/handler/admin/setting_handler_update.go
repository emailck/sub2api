...
type UpdateSettingsRequest struct {
	...
	OpenAICodexTicketAccountTypes          *[]string `json:"openai_codex_ticket_account_types"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		OpenAICodexTicketAccountTypes: func() []string {
			if req.OpenAICodexTicketAccountTypes != nil {
				return *req.OpenAICodexTicketAccountTypes
			}
			return previousSettings.OpenAICodexTicketAccountTypes
		}(),
	...
	payload := dto.SystemSettings{
		...
		OpenAICodexTicketAccountTypes:                          updatedSettings.OpenAICodexTicketAccountTypes,
